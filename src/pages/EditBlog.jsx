                                ...
                                <form>
                                    <div className="row g-4">
                                        <div className="col-md-4">
                                            ...
                                            <input type="text" name="title" className="form-control common-input border" value="lorem Ipsum" />
                                        </div>

                                        <div className="col-md-4">
                                            <label className="form-label mb-2 font-18 font-heading fw-600">Date</label>
                                            <input type="date" name="" className="form-control common-input border" value="12-09-2025" />
                                        </div>

                                        <div className="col-md-4">
                                            <label className="form-label mb-2 font-18 font-heading fw-600">Blog Author</label>
                                            <input type="text" name="" className="form-control common-input border" value="Admin" />
                                        </div>

                                        <div className="col-md-4">
                                            <label className="form-label mb-2 font-18 font-heading fw-600">Blog Slug</label>
                                            <input type="text" name="" className="form-control common-input border" value="gfhfgh ghfgj" />
                                        </div>

                                        <div className="col-md-4">
                                            <label className="form-label mb-2 font-18 font-heading fw-600">SEO Title</label>
                                            <input type="text" name="" className="form-control common-input border" value="nbvSDzfd cvbgv" />
                                        </div>
                                        <div className="col-md-4">
                                            <label className="form-label mb-2 font-18 font-heading fw-600">SEO Keywords</label>
                                            <input type="text" name="" className="form-control common-input border" value="hgj jhgj vbjhm nghgv " />
                                        </div>


                                        <div className="col-md-6">
                                            <label className="form-label mb-2 font-18 font-heading fw-600">SEO Description</label>
                                            <textarea name="" id="" rows={3} className="common-input border ">hfhhhghg</textarea>
                                        </div>
                                        <div className="col-md-6">
